        ...
        <div class="bg-white  shadow rounded p-6">
            <form action="{{ route('todo.update', $todo->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="job_applied" type="text" name="job_applied" class="w-full mt-1 p-2 border rounded" value="{{ old('job_applied', $todo->job_applied ?? '') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="place" name="place" class="w-full mt-1 p-2 border rounded">{{ old('place', $todo->place ?? '') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input id="date_applied" type="date" name="date_applied" class="w-full mt-1 p-2 border rounded" value="{{ old('date_applied', $todo->date_applied ?? '') }}">
